...
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onResume() {
        super.onResume()
        Timber.d("asd -> onResume: CALLED")
    }

    override fun onPause() {
        super.onPause()
        Timber.d("asd -> onPause: CALLED")
    }

    override fun onStop() {
        super.onStop()
        Timber.d("asd -> onStop: CALLED")
    }

    override fun onSaveInstanceState(outState: Bundle) {
        super.onSaveInstanceState(outState)
        Timber.d("asd -> onSaveInstanceState: CALLED")
    ...
    override fun onDestroy() {
        super.onDestroy()
        Timber.d("asd -> onDestroy: CALLED")
    }

    override fun onRestart() {
        super.onRestart()
        Timber.d("asd -> onRestart: CALLED")
    }
}
